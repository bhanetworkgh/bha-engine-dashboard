...
export const WORKFLOWS: SeedRow[] = [
  ...
  W('G6Myypk64kpcaVhz', 'North Star — Tools Router', 'North Star Twin', 'North Star Agent', 'Routing', 'Destiny Arupi', 'sub-workflow', 'Called by North Star — Conversational Agent and North Star — Weekly Status',
    'Every tool the North Star agent can call lands here, so all read and write logic stays in one reviewable place.', 'retired',
    "Unpublished in n8n on 24 Sep 2026 and retired by Destiny, once the North Star Agent behind North Star — Agent Delivery was re-tested on read_slack, read_open_loops and get_priority_evidence on the dashboard MCP, which replace its RS, ROL and PE branches."),
  ...
  W('cnOz6iomtnWVXjso', 'North Star — Agent Delivery', 'North Star Twin', 'North Star Agent', 'Agent', 'Destiny Arupi', 'sub-workflow', 'Called by North Star — Front Door',
    ...
    'production', "Added 24 Sep 2026 (id confirmed by Destiny). The North Star Agent's tools are read_slack, read_open_loops and get_priority_evidence on the dashboard MCP (live 24 Sep, 3954e59: re-tested with each called once — 19,882 / 13,438 / 19,974 chars — and no loop); the Tools Router (G6Myypk64kpcaVhz) that held them is retired."),
