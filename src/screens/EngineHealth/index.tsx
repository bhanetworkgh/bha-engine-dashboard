 ...
 */
/**
 * Eight tabs. **MCP writes** (2026-09-24) is every create, update, archive
 * and delete made over the MCP write connection, refusals included.
 * **Recovery** (2026-09-23) is the third thing that can happen
...
export default function EngineHealth() {
  ...
  return (
    <div className="relative flex h-full min-h-0 flex-col">
      ...
      {/*
        Nothing below the table on All systems (2026-09-22, Destiny): the
        table is the page. The final-import panel that stood here was already
        off the page once Airtable was retired; it is no longer mounted at all.
      */}
